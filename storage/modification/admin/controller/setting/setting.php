	...
	public function index() {
		...
		if (isset($this->request->post['config_error_filename'])) {
			...
			$data['config_error_filename'] = $this->config->get('config_error_filename');
				...
				if (isset($this->request->post['config_testimonial_photo'])) {
					$data['config_testimonial_photo'] = $this->request->post['config_testimonial_photo'];
				} else {
					$data['config_testimonial_photo'] = $this->config->get('config_testimonial_photo');
				}
				
				if (isset($this->request->post['config_testimonial_photo_width'])) {
					$data['config_testimonial_photo_width'] = $this->request->post['config_testimonial_photo_width'];
				} elseif ($this->config->get('config_testimonial_photo_width')) {
					$data['config_testimonial_photo_width'] = $this->config->get('config_testimonial_photo_width');
				} else {
					$data['config_testimonial_photo_width'] = 100;
				}
				
				if (isset($this->request->post['config_testimonial_photo_height'])) {
					$data['config_testimonial_photo_height'] = $this->request->post['config_testimonial_photo_height'];
				} elseif ($this->config->get('config_testimonial_photo_height')) {
					$data['config_testimonial_photo_height'] = $this->config->get('config_testimonial_photo_height');
				} else {
					$data['config_testimonial_photo_height'] = 100;
				}
				
				if (isset($this->request->post['config_testimonial_date_added'])) {
					$data['config_testimonial_date_added'] = $this->request->post['config_testimonial_date_added'];
				} else {
					$data['config_testimonial_date_added'] = $this->config->get('config_testimonial_date_added');
				}
