...
/* butik/template/common/cart.twig */
class __TwigTemplate_1c1484bf8e807fe8848b58b95a3c4d76f728e4ce78437699229aec4e9593c766 extends Twig_Template
{
  ...
  <button type=\"button\" data-toggle=\"dropdown\" data-loading-text=\"";
        ...
        echo "\" class=\"btn btn-inverse btn-block btn-lg dropdown-toggle\"><i class=\"fa fa-shopping-bag\"></i> <span id=\"cart-total\">";
...
";
    ...
    {
        return "butik/template/common/cart.twig";
    }
...
/*   <button type="button" data-toggle="dropdown" data-loading-text="{{ text_loading }}" class="btn btn-inverse btn-block btn-lg dropdown-toggle"><i class="fa fa-shopping-bag"></i> <span id="cart-total">{{ text_items }}</span></button>*/
/*   <ul class="dropdown-menu pull-right">*/
