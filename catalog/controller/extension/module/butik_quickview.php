<?php
class ControllerExtensionModuleButikQuickview extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        if ($product_info) {
            ...
            $data['butik_additional_tabs'] = $this->config->get('module_butik_additional_tabs_status');
            ...
            $butik_soc_code = $this->config->get('butik_soc_code');
            ...
            foreach ($results as $result) {
                $data['images'][] = array(
                    ...
                    'thumb_quickview' => $this->model_tool_image->resize($result['image'], $this->config->get('theme_' . $this->config->get('config_theme') . '_image_thumb_width'), $this->config->get('theme_' . $this->config->get('config_theme') . '_image_thumb_height'))
                );
            }
            ...
            $this->response->setOutput($this->load->view('extension/module/butik_quickview', $data));
        } else {
            $url = '';
    ...
    public function review() {
        ...
        $pagination->limit = 5;
        $pagination->url = $this->url->link('product/butik_quickview/review', 'product_id=' . $this->request->get['product_id'] . '&page={page}');
