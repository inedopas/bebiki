nitro.register('cachemanager', (function($) {
  ...
  var clearImageCache = function() {
    ...
    $.ajax({
      url: 'index.php?route=extension/module/nitro/clearimagecacheajax&user_token=' + token,
      dataType: 'json',
  ...
  var clearPageCache = function() {
    ...
    $.ajax({
      url: 'index.php?route=extension/module/nitro/clearpagecacheajax&user_token=' + token,
      dataType: 'json',
      success: function(resp) {
        if (resp.done) {
  ...
  var clearDBCache = function() {
    ...
    $.ajax({
      url: 'index.php?route=extension/module/nitro/cleardbcacheajax&user_token=' + token,
      dataType: 'json',
      success: function(resp) {
        if (resp.done) {
  ...
  var clearCSSCache = function() {
    ...
    $.ajax({
      url: 'index.php?route=extension/module/nitro/clearcsscacheajax&user_token=' + token,
      dataType: 'json',
      success: function(resp) {
        if (resp.done) {
  ...
  var clearJSCache = function() {
    ...
    $.ajax({
      url: 'index.php?route=extension/module/nitro/clearjscacheajax&user_token=' + token,
      dataType: 'json',
      success: function(resp) {
        if (resp.done) {
  ...
  var clearSystemCache = function() {
    ...
    $.ajax({
      url: 'index.php?route=extension/module/nitro/clearsystemcacheajax&user_token=' + token,
      dataType: 'json',
      success: function(resp) {
        if (resp.done) {
  ...
  var clearVqmodCache = function() {
    ...
    $.ajax({
      url: 'index.php?route=extension/module/nitro/clearvqmodcacheajax&user_token=' + token,
      dataType: 'json',
      success: function(resp) {
        if (resp.done) {
